...
本书写作过程中，依赖 **knitr** [@xie2015]、**rmarkdown** [@xie2018; @xie2020] 和 **bookdown** [@xie2016]，书籍在 `r R.version.string` 下编译，最新一次编译时间是 `r format(Sys.time(), tz = "Asia/Shanghai")`，使用的 R 包如下：

```{r package-info}
xfun::session_info(packages = c(
  "knitr", "rmarkdown", "bookdown", "ggplot2", "kableExtra", 
  "showtext", "tikzDevice", "magick", "pdftools"
), dependencies = FALSE)
```
