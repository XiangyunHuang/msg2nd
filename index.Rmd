...
本书是《现代统计图形》[@msg2021] 的后续，尚处于草创阶段，欢迎大家参与。
...
```{r noto-fonts, fig.cap="本书图形中英文字体设置", fig.subcap=c('中英文字体在 Base R 图里', '中英文字体在 ggplot2 图里'), out.width='45%', fig.width=4.5, fig.height=3.5, fig.align='center', fig.alt='汞蒸气的压力随温度的指数级变化', fig.showtext=TRUE, fig.ncol=2}
# 准备 Noto 中英文字体
