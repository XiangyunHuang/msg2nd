...
title(xlab = "组", ylab = "植物干重", family = "source-han-serif-cn")
...
mtext("数据集的四重奏", outer = TRUE, family = "source-han-serif-cn")
```
...
levelplot(volcano,
  ...
  par.settings = list(
    # x/y 轴标签字体，刻度标签字体
    par.xlab.text = list(fontfamily = "source-han-serif-cn"),
    par.ylab.text = list(fontfamily = "source-han-serif-cn"),
...
另一个值得一提的是 **lattice** 的绘图能力被大大低估了，和 ggplot2 同出一脉，但知名度远远不及
...
show.settings(x = trellis.par.set(list(
  axis.text = list(fontfamily = "sans"), # 轴标签
...
ggplot(data = dat, aes(x = sex, y = deaths, fill = age)) +
  ...
  theme_bw(base_size = 13, base_family = "source-han-serif-cn") +
...
国内也有很多，比如《统计发展史》[@Chen1987]、《数理统计学简史》[@Chen2000] 和《统计学漫话》[@Chen2016]，
还有人物传记类，比如《Neyman》[@Reid1982] 及其译作[@Neyman1987]、《漫漫修远攻算路：方开泰自述》 [@Fang2016] 和《道德文章垂范人间：纪念许宝騄先生百年诞辰》 [@Xu2010]，
还有一些文章，比如吴建福老师的《从历史发展看中国统计发展方向》[@Jeff1986]和《统计学者的工作及风范：灵感、抱负、雄心》[@Jeff2011]，以及他 2018 年在北大的讲座 [对中国统计发展的一些浅见](https://www.stat.pku.edu.cn/xwzx/xw/98359.htm)，还有 2010年新办的杂志[《数学文化》](https://www.global-sci.com/mc.html)，2009年丘成桐、杨乐等主编的[《数学与人文》](http://www.intlpress.net/mh/)丛书等，[统计之都](https://cosx.org/)也有大量访谈形式的文章，非常值得一读。真是篇幅所限，没法一一列举。培养开阔的思维，广泛的人际关系和优秀的沟通能力，不走极端，专业技术只是决定你的起点，软实力将决定你的高度。以史为镜可知兴替，突破自己的局限，少犯一些错误。要认识到往往是时势造就了英雄，环境对人的影响很大，大到国家，小到团队组织，事情能否做成往往取决于环境，而不是个人能力。若能从历史中看到未来的变化趋势，顺势而为，则善莫大焉，只要在风口上，猪都能飞起来，更是屡见不鲜！
