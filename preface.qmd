...
8.  应用部分，数据集取材于 BBC，经济学人，尽可能来源于真实场景，比如 kaggle 数学建模，天池比赛，黑子活动这样的 R 内置数据集也可以扩展的如今，分析的对象不做限制。目的：一是紧跟时代，二是加强读者对统计学的了解，向来从历史和人物的角度引入比较容易让人接受。
...
将对比对象从年龄转化为城乡，描述城乡差距在死亡率上的体现，是不是得到更多的信息含量？城市化降低人的死亡率。

```{r}
#| label: fig-virginia-deaths-site
#| fig-cap: 1940 年弗吉尼亚州死亡率的城乡差异
#| out-width: 75%
#| fig-width: 6
#| fig-height: 6
#| fig-showtext: true
