...
```{python matplotlib, fig.cap="matplotlib 示例", echo=FALSE, dev=ifelse(knitr::is_html_output(),'svg', ifelse(knitr::is_latex_output(),'pdf','png')), out.width='45%', fig.width=4, fig.height=4, collapse=TRUE}
...
JavaScript 库 Plotly 的 Python 接口，如图\@ref(fig:python-plotly)所示，iris 鸢尾花数据集按花种类分组线性回归，展示相关性。

```{python, python-plotly, fig.cap="JavaScript 库 Plotly 的 Python 接口", echo=FALSE, eval=knitr::is_html_output()}
