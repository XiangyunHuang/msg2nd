...
图 \@ref(fig:matplotlib) 是一个迷你的 matplotlib 示例

```{python matplotlib, fig.cap="matplotlib 示例", echo=FALSE, dev=ifelse(knitr::is_html_output(),'svg', ifelse(knitr::is_latex_output(),'pdf','png')), out.width='45%', fig.width=4, fig.height=3.5, collapse=TRUE}
...
JavaScript 库 Plotly 的 Python 接口，如图\@ref(fig:plotly-ols)所示，iris 鸢尾花数据集按花种类分组线性回归，展示相关性。

```{python plotly-ols, fig.cap="JavaScript 库 Plotly 的 Python 接口", echo=FALSE, out.width='65%', eval=knitr::is_html_output()}
...
```{r iris-ggplot2, fig.cap="Edgar Anderson 的鸢尾花数据", fig.showtext=TRUE, fig.width=5, fig.height=3, out.width="65%", echo=FALSE}
library(ggplot2)
